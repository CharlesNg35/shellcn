...
func Routes() []plugin.Route {
	return []plugin.Route{
		...
		{ID: "docker.container.mounts", Method: plugin.MethodGet, Path: "/containers/{id}/mounts", Permission: "docker.containers.read", Risk: plugin.RiskSafe, AuditEvent: "docker.container.mounts", Handle: dockerengine.ContainerMounts},
