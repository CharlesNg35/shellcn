...
func Routes() []plugin.Route {
	return []plugin.Route{
		...
		{ID: "docker.container.exec.prepare", Method: plugin.MethodPost, Path: "/containers/{id}/exec", Permission: "docker.containers.exec", Risk: plugin.RiskPrivileged, AuditEvent: "docker.container.exec.prepare", Handle: dockerengine.PrepareExec},
