...
func Routes() []plugin.Route {
	return []plugin.Route{
		...
		{ID: "docker.network.connect", Method: plugin.MethodPost, Path: "/networks/{id}/connect", Permission: "docker.networks.write", Risk: plugin.RiskWrite, AuditEvent: "docker.network.connect", Input: dockerengine.NetworkConnectSchema(), Handle: dockerengine.ConnectNetwork},
		{ID: "docker.network.disconnect", Method: plugin.MethodPost, Path: "/networks/{id}/disconnect", Permission: "docker.networks.write", Risk: plugin.RiskWrite, AuditEvent: "docker.network.disconnect", Input: dockerengine.NetworkDisconnectSchema(), Handle: dockerengine.DisconnectNetwork},
