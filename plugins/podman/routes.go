...
func Routes() []plugin.Route {
	return []plugin.Route{
		...
		{ID: "podman.container.exec.prepare", Method: plugin.MethodPost, Path: "/containers/{id}/exec", Permission: "podman.containers.exec", Risk: plugin.RiskPrivileged, AuditEvent: "podman.container.exec.prepare", Handle: dockerengine.PrepareExec},
