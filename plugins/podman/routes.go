...
func Routes() []plugin.Route {
	return []plugin.Route{
		...
		{ID: "podman.container.open", Method: plugin.MethodGet, Path: "/containers/{id}/open", Permission: "podman.containers.read", Risk: plugin.RiskSafe, AuditEvent: "podman.container.open", Handle: dockerengine.ContainerProxyURL},
