...
func Routes() []plugin.Route {
	return []plugin.Route{
		...
		{ID: "podman.network.connect", Method: plugin.MethodPost, Path: "/networks/{id}/connect", Permission: "podman.networks.write", Risk: plugin.RiskWrite, AuditEvent: "podman.network.connect", Input: dockerengine.NetworkConnectSchema(), Handle: dockerengine.ConnectNetwork},
		{ID: "podman.network.disconnect", Method: plugin.MethodPost, Path: "/networks/{id}/disconnect", Permission: "podman.networks.write", Risk: plugin.RiskWrite, AuditEvent: "podman.network.disconnect", Input: dockerengine.NetworkDisconnectSchema(), Handle: dockerengine.DisconnectNetwork},
