...
func Routes() []plugin.Route {
	return []plugin.Route{
		...
		{ID: "podman.events.list", Method: plugin.MethodGet, Path: "/events/recent", Permission: "podman.events.read", Risk: plugin.RiskSafe, AuditEvent: "podman.events.list", Handle: dockerengine.EventsTimeline},
		...
		{ID: "podman.container.processes", Method: plugin.MethodGet, Path: "/containers/{id}/processes", Permission: "podman.containers.read", Risk: plugin.RiskSafe, AuditEvent: "podman.container.processes", Handle: dockerengine.ContainerProcesses},
		...
		{ID: "podman.image.history", Method: plugin.MethodGet, Path: "/images/{id}/history", Permission: "podman.images.read", Risk: plugin.RiskSafe, AuditEvent: "podman.image.history", Handle: dockerengine.ImageHistory},
		...
		{ID: "podman.volume.backup", Method: plugin.MethodGet, Path: "/volumes/{id}/backup", Permission: "podman.volumes.read", Risk: plugin.RiskPrivileged, AuditEvent: "podman.volume.backup", Handle: dockerengine.VolumeBackup},
		{ID: "podman.volume.backup.url", Method: plugin.MethodGet, Path: "/volumes/{id}/backup-url", Permission: "podman.volumes.read", Risk: plugin.RiskPrivileged, AuditEvent: "podman.volume.backup.url", Handle: dockerengine.VolumeBackupURLFor("podman.volume.backup")},
		...
		{ID: "podman.network.ports", Method: plugin.MethodGet, Path: "/networks/ports", Permission: "podman.networks.read", Risk: plugin.RiskSafe, AuditEvent: "podman.network.ports", Handle: dockerengine.NetworkPorts},
		{ID: "podman.network.topology", Method: plugin.MethodGet, Path: "/networks/topology", Permission: "podman.networks.read", Risk: plugin.RiskSafe, AuditEvent: "podman.network.topology", Handle: dockerengine.NetworkTopology},
		...
		{ID: "podman.container.mounts", Method: plugin.MethodGet, Path: "/containers/{id}/mounts", Permission: "podman.containers.read", Risk: plugin.RiskSafe, AuditEvent: "podman.container.mounts", Handle: dockerengine.ContainerMounts},
		{ID: "podman.container.open", Method: plugin.MethodGet, Path: "/containers/{id}/open", Permission: "podman.containers.read", Risk: plugin.RiskSafe, AuditEvent: "podman.container.open", Input: dockerengine.ContainerOpenSchema("podman.container.open.ports"), Handle: dockerengine.ContainerProxyURL},
		{ID: "podman.container.open.ports", Method: plugin.MethodGet, Path: "/containers/{id}/open/ports", Permission: "podman.containers.read", Risk: plugin.RiskSafe, AuditEvent: "podman.container.open.ports", Handle: dockerengine.ContainerOpenPorts},
		...
		{ID: "podman.container.pause", Method: plugin.MethodPost, Path: "/containers/{id}/pause", Permission: "podman.containers.write", Risk: plugin.RiskWrite, AuditEvent: "podman.container.pause", Handle: dockerengine.PauseContainer},
		{ID: "podman.container.unpause", Method: plugin.MethodPost, Path: "/containers/{id}/unpause", Permission: "podman.containers.write", Risk: plugin.RiskWrite, AuditEvent: "podman.container.unpause", Handle: dockerengine.UnpauseContainer},
		{ID: "podman.container.kill", Method: plugin.MethodPost, Path: "/containers/{id}/kill", Permission: "podman.containers.write", Risk: plugin.RiskDestructive, AuditEvent: "podman.container.kill", Input: dockerengine.KillContainerSchema(), Handle: dockerengine.KillContainer},
		{ID: "podman.container.rename", Method: plugin.MethodPost, Path: "/containers/{id}/rename", Permission: "podman.containers.write", Risk: plugin.RiskWrite, AuditEvent: "podman.container.rename", Input: dockerengine.RenameContainerSchema(), Handle: dockerengine.RenameContainer},
		{ID: "podman.container.commit", Method: plugin.MethodPost, Path: "/containers/{id}/commit", Permission: "podman.images.write", Risk: plugin.RiskWrite, AuditEvent: "podman.container.commit", Input: dockerengine.CommitContainerSchema(), Handle: dockerengine.CommitContainer},
		{ID: "podman.container.redeploy", Method: plugin.MethodPost, Path: "/containers/{id}/redeploy", Permission: "podman.containers.write", Risk: plugin.RiskDestructive, AuditEvent: "podman.container.redeploy", Input: dockerengine.RedeployContainerSchema(), Handle: dockerengine.RedeployContainer},
		...
		{ID: "podman.image.build", Method: plugin.MethodPost, Path: "/images/build", Permission: "podman.images.write", Risk: plugin.RiskWrite, AuditEvent: "podman.image.build", Input: dockerengine.ImageBuildSchema(), Handle: dockerengine.BuildImage},
		{ID: "podman.image.tag", Method: plugin.MethodPost, Path: "/images/{id}/tag", Permission: "podman.images.write", Risk: plugin.RiskWrite, AuditEvent: "podman.image.tag", Input: dockerengine.ImageTagSchema(), Handle: dockerengine.TagImage},
		{ID: "podman.image.push", Method: plugin.MethodPost, Path: "/images/{id}/push", Permission: "podman.images.write", Risk: plugin.RiskWrite, AuditEvent: "podman.image.push", Input: dockerengine.ImagePushSchema(), Handle: dockerengine.PushImage},
		...
		{ID: "podman.network.create", Method: plugin.MethodPost, Path: "/networks/create", Permission: "podman.networks.write", Risk: plugin.RiskWrite, AuditEvent: "podman.network.create", Input: dockerengine.PodmanNetworkCreateSchema(), Handle: dockerengine.CreateNetwork},
		{ID: "podman.network.connect", Method: plugin.MethodPost, Path: "/networks/{id}/connect", Permission: "podman.networks.write", Risk: plugin.RiskWrite, AuditEvent: "podman.network.connect", Input: dockerengine.NetworkConnectSchema("podman.containers.list"), Handle: dockerengine.ConnectNetwork},
		{ID: "podman.network.disconnect", Method: plugin.MethodPost, Path: "/networks/{id}/disconnect", Permission: "podman.networks.write", Risk: plugin.RiskWrite, AuditEvent: "podman.network.disconnect", Input: dockerengine.NetworkDisconnectSchema("podman.containers.list"), Handle: dockerengine.DisconnectNetwork},
		...
		{ID: "podman.container.stats", Method: plugin.MethodWS, Path: "/containers/{id}/stats", Permission: "podman.containers.read", Risk: plugin.RiskSafe, AuditEvent: "podman.container.stats", Stream: dockerengine.ContainerStats},
		{ID: "podman.events.watch", Method: plugin.MethodWS, Path: "/events", Permission: "podman.events.read", Risk: plugin.RiskSafe, AuditEvent: "podman.events.watch", Stream: dockerengine.DockerEventStream},
		{ID: "podman.events.object.watch", Method: plugin.MethodWS, Path: "/events/object", Permission: "podman.events.read", Risk: plugin.RiskSafe, AuditEvent: "podman.events.object.watch", Stream: dockerengine.DockerObjectWatch},
		{ID: "podman.events.timeline.watch", Method: plugin.MethodWS, Path: "/events/timeline", Permission: "podman.events.read", Risk: plugin.RiskSafe, AuditEvent: "podman.events.timeline.watch", Stream: dockerengine.DockerTimelineWatch},
	}
}
