...
var kinds = []kind{
	...
	},
	{
		...
		extra:   deploymentRow, actionIDs: []string{"kubernetes.resource.scale", "kubernetes.resource.restart", "kubernetes.rollout.undo", "kubernetes.resource.delete"}, detailTabs: workloadDetailTabs("deployment"),
	},
	{
		...
		extra:   statefulSetRow, actionIDs: scalable, detailTabs: workloadDetailTabs("statefulset"),
	},
	{
		...
		extra:   daemonSetRow, actionIDs: []string{"kubernetes.resource.restart", "kubernetes.resource.delete"}, detailTabs: workloadDetailTabs("daemonset"),
	},
	{
		...
		extra:   replicaSetRow, actionIDs: scalable, detailTabs: workloadDetailTabs("replicaset"),
	},
	{
		...
		extra:   jobRow, actionIDs: justDelete, detailTabs: workloadDetailTabs("job"),
	},
	{
	...
	},
	{
		...
		extra:   replicationControllerRow, actionIDs: scalable, detailTabs: workloadDetailTabs("replicationcontroller"),
	},
	{
