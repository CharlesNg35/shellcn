...
func configSchema() plugin.Schema {
	...
	return plugin.Schema{Groups: []plugin.Group{
		...
		{Name: "Authentication", Fields: []plugin.Field{
			{Key: "username", Label: "Username", Type: plugin.FieldText, Required: true, Placeholder: "sa"},
			...
			}, Help: "Reusable SQL Server password. The credential identity can also supply the username."},
