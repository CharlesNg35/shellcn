	...
	return []plugin.ResourceType{
		{
			...
			Detail: plugin.DetailView{Header: plugin.HeaderSpec{Title: "${resource.name}", ActionIDs: []string{
				...
				{Key: "synonyms", Label: "Synonym sets", Icon: icon("replace"), Panel: plugin.PanelTable, Source: &plugin.DataSource{RouteID: rid("synonyms.list")}, Config: plugin.TableConfig{Columns: synonymColumns(), ActionIDs: []string{rid("synonym.upsert")}, RowActionIDs: []string{rid("synonym.delete")}, Exportable: true}.Map()},
				{Key: "overrides", Label: "Curation sets", Icon: icon("pin"), Panel: plugin.PanelTable, Source: &plugin.DataSource{RouteID: rid("overrides.list")}, Config: plugin.TableConfig{Columns: overrideColumns(), ActionIDs: []string{rid("override.upsert")}, RowActionIDs: []string{rid("override.delete")}, Exportable: true}.Map()},
