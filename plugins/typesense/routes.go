...
func Routes() []plugin.Route {
	return []plugin.Route{
		...
		{ID: rid("synonyms.list"), Method: plugin.MethodGet, Path: "/collections/{collection}/synonyms", Permission: "typesense.synonyms.read", Risk: plugin.RiskSafe, AuditEvent: rid("synonyms.list"), Handle: listSynonyms},
		{ID: rid("synonym.upsert"), Method: plugin.MethodPut, Path: "/collections/{collection}/synonyms", Permission: "typesense.synonyms.write", Risk: plugin.RiskWrite, AuditEvent: rid("synonym.upsert"), Input: synonymUpsertSchema(), Handle: upsertSynonym},
		{ID: rid("synonym.delete"), Method: plugin.MethodDelete, Path: "/collections/{collection}/synonyms/{synonym}", Permission: "typesense.synonyms.delete", Risk: plugin.RiskDestructive, AuditEvent: rid("synonym.delete"), Handle: deleteSynonym},
		{ID: rid("overrides.list"), Method: plugin.MethodGet, Path: "/collections/{collection}/overrides", Permission: "typesense.overrides.read", Risk: plugin.RiskSafe, AuditEvent: rid("overrides.list"), Handle: listOverrides},
		{ID: rid("override.upsert"), Method: plugin.MethodPut, Path: "/collections/{collection}/overrides", Permission: "typesense.overrides.write", Risk: plugin.RiskWrite, AuditEvent: rid("override.upsert"), Input: overrideUpsertSchema(), Handle: upsertOverride},
		{ID: rid("override.delete"), Method: plugin.MethodDelete, Path: "/collections/{collection}/overrides/{override}", Permission: "typesense.overrides.delete", Risk: plugin.RiskDestructive, AuditEvent: rid("override.delete"), Handle: deleteOverride},
