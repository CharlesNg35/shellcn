...
func (p *Plugin) Manifest() plugin.Manifest {
	return plugin.Manifest{
		...
		Version:             "0.1.0",
		Title:               "Amazon S3",
		Description:         "File browser for Amazon S3 buckets.",
...
func (p *Plugin) Connect(ctx context.Context, cfg plugin.ConnectConfig) (plugin.Session, error) {
	return s3compat.Connect(ctx, cfg, s3compat.Options{VerifyTLS: true, RequireBucket: true})
}
