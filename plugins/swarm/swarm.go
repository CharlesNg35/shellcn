...
func actions() []plugin.Action {
	return []plugin.Action{
		...
		{ID: "swarm.service.remove", Label: "Remove", Icon: icon("trash"), RouteID: "swarm.service.remove", Params: map[string]string{"id": "${resource.uid}"}, Confirm: true, ConfirmText: "Remove this service?", OnSuccess: &plugin.ActionSuccess{Navigate: plugin.NavigateList}},
		{ID: "swarm.node.update", Label: "Update", Icon: icon("settings"), RouteID: "swarm.node.update", Params: map[string]string{"id": "${resource.uid}"}, Confirm: true, ConfirmText: "Update this node's availability or role?"},
		{ID: "swarm.stack.deploy", Label: "Deploy stack", Icon: icon("upload"), RouteID: "swarm.stack.deploy", Confirm: true, ConfirmText: "Deploy this stack and create or update services?"},
	}
}
