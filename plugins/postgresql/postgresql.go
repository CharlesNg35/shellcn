...
func actions() []plugin.Action {
	return []plugin.Action{
		...
		{ID: "postgresql.column.drop", Label: "Drop column", Icon: icon("trash"), RouteID: "postgresql.column.drop", Params: map[string]string{"schema": "${record.schema}", "table": "${record.table}", "name": "${record.name}"}, Confirm: true, ConfirmText: "Drop this column? Its data is permanently removed.", OnSuccess: &plugin.ActionSuccess{SelectTab: "columns"}},
		...
		{ID: "postgresql.constraint.drop", Label: "Drop constraint", Icon: icon("trash"), RouteID: "postgresql.constraint.drop", Params: map[string]string{"schema": "${record.schema}", "table": "${record.table}", "name": "${record.name}"}, Confirm: true, ConfirmText: "Drop this constraint?", OnSuccess: &plugin.ActionSuccess{SelectTab: "constraints"}},
