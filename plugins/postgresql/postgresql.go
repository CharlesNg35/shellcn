...
func tree() []plugin.TreeGroup {
	return []plugin.TreeGroup{
		{Key: "databases", Label: "Databases", Icon: icon("database"), Source: plugin.DataSource{RouteID: "postgresql.tree.databases"}, ResourceKind: "database"},
	}
}
	...
	return plugin.ResourceType{
		...
		Detail: plugin.DetailView{
			...
			Tabs: []plugin.Tab{
				...
				{Key: "views", Label: "Views", Icon: icon("panel-top"), Panel: plugin.PanelTable, Source: &plugin.DataSource{RouteID: "postgresql.views.list", Params: schemaParams()}, Config: plugin.TableConfig{Columns: viewColumns()}.Map()},
	...
	return plugin.ResourceType{
		...
		Detail: plugin.DetailView{
			...
			Tabs: []plugin.Tab{
				...
				{Key: "indexes", Label: "Indexes", Icon: icon("key-round"), Panel: plugin.PanelTable, Source: &plugin.DataSource{RouteID: "postgresql.table.indexes", Params: tableParams()}, Config: plugin.TableConfig{Columns: indexColumns(), ActionIDs: []string{"postgresql.index.create", "postgresql.index.drop"}}.Map()},
...
func actions() []plugin.Action {
	return []plugin.Action{
		...
		{ID: "postgresql.column.drop", Label: "Drop column", Icon: icon("trash"), RouteID: "postgresql.column.drop", Params: tableParams(), Confirm: true, ConfirmText: "Drop this column? Its data is permanently removed.", OnSuccess: &plugin.ActionSuccess{SelectTab: "columns"}},
		...
		{ID: "postgresql.index.drop", Label: "Drop index", Icon: icon("trash"), RouteID: "postgresql.index.drop", Params: tableParams(), Confirm: true, ConfirmText: "Drop this index?", OnSuccess: &plugin.ActionSuccess{SelectTab: "indexes"}},
