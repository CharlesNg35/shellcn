...
func configSchema() plugin.Schema {
	...
	return plugin.Schema{Groups: []plugin.Group{
		{Name: "Server", Fields: []plugin.Field{
			{Key: "host", Label: "Host", Type: plugin.FieldText, Required: true, Placeholder: "db.example.internal"},
		...
		{Name: "Safety", Fields: []plugin.Field{
			...
			{Key: "require_destructive_confirmation", Label: "Confirm destructive statements", Type: plugin.FieldToggle, Default: true, Help: "Requires explicit confirmation before statements such as INSERT, UPDATE, DELETE, DDL, TRUNCATE, VACUUM, GRANT, and REVOKE execute."},
...
func parseOptions(cfg plugin.ConnectConfig) (options, error) {
	...
	return options{
		...
		RowLimit:          rowLimit,
		MaxConns:          maxConns,
		ApplicationName:   plugin.DefaultClientName,
...
func poolConfig(opts options, netTransport plugin.NetTransport) (*pgxpool.Config, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("%w: invalid PostgreSQL connection config: %v", plugin.ErrInvalidInput, err)
	}
