...
// Connection represents a reusable remote access definition scoped to an organisation or team.
type Connection struct {
	BaseModel

	Name           string         `gorm:"not null;uniqueIndex:idx_connections_org_name" json:"name"`
