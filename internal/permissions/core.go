...
func init() {
	perms := []*Permission{
		...
		{
			ID:           "session.active.view_team",
			Module:       "core",
			DependsOn:    []string{"connection.view"},
			Category:     "sessions",
			DisplayName:  "View Team Active Sessions",
			Description:  "View active sessions for teams you belong to",
			DefaultScope: "team",
		},
		{
			ID:           "session.active.view_all",
			Module:       "core",
			DependsOn:    []string{"session.active.view_team"},
			Implies:      []string{"session.active.view_team"},
			Category:     "sessions",
			DisplayName:  "View All Active Sessions",
			Description:  "View active sessions across all connections and teams",
			DefaultScope: "global",
		},
		{
			ID:           "session.recording.view",
			Module:       "core",
			DependsOn:    []string{"connection.view"},
			Category:     "sessions",
			DisplayName:  "View Session Recordings",
			Description:  "View session recordings you own or created",
			DefaultScope: "personal",
		},
		{
			ID:           "session.recording.view_team",
			Module:       "core",
			DependsOn:    []string{"session.recording.view"},
			Implies:      []string{"session.recording.view"},
			Category:     "sessions",
			DisplayName:  "View Team Session Recordings",
			Description:  "View session recordings for teams you belong to",
			DefaultScope: "team",
		},
		{
			ID:           "session.recording.view_all",
			Module:       "core",
			DependsOn:    []string{"session.recording.view_team"},
			Implies:      []string{"session.recording.view_team", "session.recording.view"},
			Category:     "sessions",
			DisplayName:  "View All Session Recordings",
			Description:  "View all session recordings across the organisation",
			DefaultScope: "global",
		},
		{
			ID:           "session.recording.delete",
			Module:       "core",
			DependsOn:    []string{"session.recording.view_all"},
			Implies:      []string{"session.recording.view_all", "session.recording.view_team", "session.recording.view"},
			Category:     "sessions",
			DisplayName:  "Delete Session Recordings",
			Description:  "Delete stored session recordings",
			DefaultScope: "global",
		},
		{
			ID:           "vault.view",
