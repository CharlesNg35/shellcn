...
_Last updated: 2026-05-25 — not started._

Legend: `[ ]` todo · `[~]` in progress · `[x]` done.
A step is `[x]` only when its **tests pass**; a phase is done when all its steps are `[x]`.

## Phase 0 — Bootstrap
- [ ] 0.1 Initialize Go module and repo skeleton
- [ ] 0.2 Scaffold the Vue + Vite frontend
- [ ] 0.3 Makefile and developer tooling
...
- [ ] 2.3 ent schema and store repositories
- [ ] 2.4 Secret vault
