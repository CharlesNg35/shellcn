		...
		Tabs: []plugin.Panel{{
			...
			Config: plugin.FileBrowserConfig{
				...
				Routes: plugin.FileBrowserRoutes{
					Read:     "sample.files.read",
					Download: "sample.files.download",
					Mkdir:    "sample.files.mkdir",
					Rename:   "sample.files.rename",
					Delete:   "sample.files.delete",
				},
				Upload:   plugin.FileUploadConfig{RouteID: "sample.files.upload", Multiple: true},
				Writable: true,
			},
		}},
