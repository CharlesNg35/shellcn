...
<template>
  <div class="flex h-full overflow-auto p-8">
    <div
      class="m-auto flex w-full max-w-md flex-col items-center gap-5 text-center"
    >
      <span
      ...
      <div class="w-full min-w-0 space-y-1">
        ...
        <p
          class="text-sm wrap-break-word text-surface-500 dark:text-surface-400"
        >
