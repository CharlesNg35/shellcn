...
new browser tab — used for generated **connection-proxy** links (e.g. "open a
Service's web UI"). The URL is typically a relative `/api/connections/{id}/proxy/…`
link served by the connection HTTP proxy (§8.1). Generic: the route decides it.
